...
public class PaymentResponsetAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<PaymentResponsetAvroModel> ENCODER =
      new BinaryMessageEncoder<PaymentResponsetAvroModel>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PaymentResponsetAvroModel> DECODER =
      new BinaryMessageDecoder<PaymentResponsetAvroModel>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<PaymentResponsetAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PaymentResponsetAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PaymentResponsetAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<PaymentResponsetAvroModel>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this PaymentResponsetAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a PaymentResponsetAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a PaymentResponsetAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static PaymentResponsetAvroModel fromByteBuffer(
   ...
   */
  public PaymentResponsetAvroModel() {}
  ...
  /**
   * Creates a new PaymentResponsetAvroModel RecordBuilder.
   * @return A new PaymentResponsetAvroModel RecordBuilder
   */
  public static com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder newBuilder() {
    return new com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder();
  }

  /**
   * Creates a new PaymentResponsetAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PaymentResponsetAvroModel RecordBuilder
   */
  public static com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder newBuilder(com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder other) {
    if (other == null) {
      return new com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder();
    } else {
      return new com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new PaymentResponsetAvroModel RecordBuilder by copying an existing PaymentResponsetAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new PaymentResponsetAvroModel RecordBuilder
   */
  public static com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder newBuilder(com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel other) {
    if (other == null) {
      return new com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder();
    } else {
      return new com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for PaymentResponsetAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponsetAvroModel>
    implements org.apache.avro.data.RecordBuilder<PaymentResponsetAvroModel> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing PaymentResponsetAvroModel instance
     * @param other The existing instance to copy.
     */
    private Builder(com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.rudy.ryanto.order.system.kafka.order.avro.model.PaymentResponsetAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    public PaymentResponsetAvroModel build() {
      try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<PaymentResponsetAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<PaymentResponsetAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<PaymentResponsetAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<PaymentResponsetAvroModel>)MODEL$.createDatumReader(SCHEMA$);
